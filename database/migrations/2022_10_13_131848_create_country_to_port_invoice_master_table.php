...
class CreateCountryToPortInvoiceMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('constants.COUNTRY_TO_PORT_GOODS_OUT_INVOICE_MASTER_TABLE'), function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('constants.COUNTRY_TO_PORT_GOODS_OUT_INVOICE_MASTER_TABLE'));
    }
}
