...
class CreateGoodsOutFbaSheetMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('constants.GOODS_OUT_FBA_SHEET_MASTER_TABLE'), function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('constants.GOODS_OUT_FBA_SHEET_MASTER_TABLE'));
    }
}
