...
class CreateUsWarehouseToAmazonInvoiceMaster extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('constants.US_WAREHOUSE_TO_AMAZON_INVOICE_MASTER_TABLE'), function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('constants.US_WAREHOUSE_TO_AMAZON_INVOICE_MASTER_TABLE'));
    }
}
