...
class CreateTrasnferEuropeMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('constants.GOODS_OUT_EUROPE_TRANSFER_MASTER_TABLE'), function (Blueprint $table) {
            $table->increments('i_id');
            $table->longText('v_europe_transfer_record_no');
            ...
            $table->longText('v_reference_no')->nullable();
            $table->integer('i_no_of_pallets')->nullable();;
    ...
    {
        Schema::dropIfExists(config('constants.GOODS_OUT_EUROPE_TRANSFER_MASTER_TABLE'));
    }
}
