...
class CreateAgentToWarehouseGoodsOutInvoiceMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('constants.AGENT_TO_WAREHOUSE_GOODS_OUT_INVOICE_MASTER_TABLE'), function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('constants.AGENT_TO_WAREHOUSE_GOODS_OUT_INVOICE_MASTER_TABLE'));
    }
}
