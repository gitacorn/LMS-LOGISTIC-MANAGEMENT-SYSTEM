...
class CreatePortToAgentGoodsOutInvoiceMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('port_to_agent_goods_out_invoice_master', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('port_to_agent_goods_out_invoice_master');
    }
}
