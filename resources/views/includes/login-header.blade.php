...
<head>
    ...
    <style>
        ...
        .login-heading-content:after {
            ...
            right: 0;
            bottom: 17%;
            -webkit-clip-path: polygon(0 0, 100% 50%, 100% 100%);
        ...
        <section>
            <div class="page-wrapper login-page" style="background-image:url('<?php echo  asset('images/shape1.png') ?>')">
                <div class="box-wrapper-login">
                    <div class="wrapper">
                        <div class="row login-heading-content">
