...
<main class="page-height bg-light-color">
	<div class="breadcrumb-wrapper d-flex border-navabr align-items-center">
		...
		<div class="ml-auto pt-sm-0 d-flex align-items-center">
			<button type="button" class="btn btn btn-theme text-white button-actions-top-bar  d-flex align-items-center border btn-sm mr-2" data-toggle="modal" data-target="#add-country-modal"><i class=" fas fa-plus mr-md-2"></i><span class="d-md-block d-none">{{ trans('messages.add-country') }} </span></a>
					...
					<div class="row align-items-center">
						<div class="col-xl-3 col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control twt-enter-search custom-input" name="search_by_country" placeholder="{{ trans('messages.search-by') }} {{ trans('messages.country-name') }} , {{ trans('messages.country-code') }}">
							</div>
						</div>
						<!-- <div class="col-xl-3 col-lg-6">
							<div class="form-group">
						...
						<table class="table table-sm table-bordered table-hover" id="country-table">
							<thead>
								<tr>
									...
									<th class="text-left" width="55%">{{ trans("messages.country-code") }}</th>
							...
							<tbody>
								<tr>
									...
									<td class="text-left" width="55%">United Kingdom</td>
									<td class="text-left" width="30%">UK</td>
								...
								<tr>
									...
									<td class="text-left" width="55%">Germany</td>
									<td class="text-left" width="30%">DE</td>
									<td class="actions-col" width="20%">
										<div class="custom-control custom-switch">
...
<div class="modal fade bd-example-modal-lg" id="add-country-modal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="modal-body add-lookup-modal-html">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label for="country_name" class="control-label">{{ trans('messages.country-name') }}<span class="text-danger">*</span></label>
								<input type="text" name="country_name" class="form-control" placeholder="{{ trans('messages.country-name') }}"> 
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<label for="country_code" class="control-label">{{ trans('messages.country-code') }}<span class="text-danger">*</span></label>
								<input type="text" name="country_code" class="form-control" placeholder="{{ trans('messages.country-code') }}">
							</div>
						</div>
					</div>
				</div>
