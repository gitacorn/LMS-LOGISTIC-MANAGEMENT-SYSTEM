...
<main class="page-height bg-light-color">
	<div class="breadcrumb-wrapper d-flex align-items-center border-navabr">
		...
		<div class="ml-auto pt-sm-0 d-flex align-items-center">
			<a href="{{ url('add-internal-transfer') }}" class="btn btn btn-theme text-white button-actions-top-bar  border btn-sm mr-2 d-flex align-items-center" title="{{ trans('messages.add-internal-transfer') }}"><i class=" fas fa-plus mr-md-1"></i> <span class="d-md-block d-none">{{ trans('messages.add') }}</span></a>
					...
					<div class="row align-items-center">
						<div class="col-xl-6 col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control twt-enter-search custom-input" name="search_by_internal_transfer" id="search_by_logistic_partner_name" placeholder="<?php echo $tableSearchPlaceholder ?>">
							</div>
						</div>
						...
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="form-group">
								...
								<select name="search_logistic_partner" class="form-control">
									<option value="">{{ trans("messages.select") }}</option>
									<option value="Airport">New York</option>
									<option value="Port">US</option>
								</select>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
						...
						<table class="table table-sm table-bordered table-hover" id="user-table">
							<thead>
								<tr>
									...
									<th class="text-left" style="max-width:150px;min-width:150px;">{{ trans("messages.way-of-transport") }}</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-left">IWT-001-07102022 </td>
									<td class="text-left">Road</td>
									<td class="text-left">Ramu Patel </td>
									<td class="text-left"> DHL </td>
									<td class="text-left">12/10/2022 </td>
									<td class="text-left">150 </td>
									<td class="text-left">1121522 </td>
									<td class="text-left">122456 <br> <a href="#"> https://www.google.com</a></td>
									<td class="text-left">20/10/2022</td>
									<td class="text-left">21/10/2022</td>
									<td class="text-left">delivered</td>
									<td>
										<a title="Edit Record" href="javascript:void(0);" class="btn btn-sm btn-info mb-1"><i class="fas fa-fw fa-pencil-alt"></i></a>
										<button title="Delete" class="btn btn-sm btn-danger mb-1"><i class="fa fa-trash fa-fw"></i></button>
