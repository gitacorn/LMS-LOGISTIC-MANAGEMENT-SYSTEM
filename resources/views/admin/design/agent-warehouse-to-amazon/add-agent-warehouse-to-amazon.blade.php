...
<main class="page-height bg-light-color">
    <div class="breadcrumb-wrapper d-md-flex border-navabr align-items-center">
        <h1 class="h3 mb-lg-0 mr-3 header-title" id="pageTitle">{{ trans("messages.add-agent-warehouse-to-amazon") }}</h1>
    </div>
                ...
                <form method="post">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label class="control-label" for="from">{{ trans("messages.from") }}<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-12 submit-sticky">
                        ...
                        <a href="{{ url('agent-warehouse-to-amazon') }}" class="btn btn-outline-secondary shadow-sm btn-wide" title="{{ trans('messages.cancel') }}">{{ trans("messages.cancel") }}</a>
                    </div>
