...
<main class="page-height bg-light-color">
    <div class="breadcrumb-wrapper d-md-flex border-navabr align-items-center">
        <h1 class="h3 mb-lg-0 mr-3 header-title" id="pageTitle">{{ trans("messages.add-to-amazon") }}</h1>
    </div>
            ...
            <div class="card mb-3 good-in-buyer-class" id="details">
                ...
                <form method="post">
                    ...
                    <div class="col-md-12 submit-sticky">
                        ...
                        <a href="{{ url('to-amazon') }}" class="btn btn-outline-secondary shadow-sm btn-wide" title="{{ trans('messages.cancel') }}">{{ trans("messages.cancel") }}</a>
                    </div>
            </div>
            </form>
        </div>
