...
<main class="page-height bg-light-color">
	<div class="breadcrumb-wrapper d-flex border-navabr align-items-center">
		...
		<div class="ml-auto pt-sm-0 d-flex align-items-center">
			<button type="button" class="btn btn btn-theme text-white button-actions-top-bar  d-flex align-items-center border btn-sm mr-2" data-toggle="modal" data-target="#add-company-modal"><i class=" fas fa-plus mr-md-2"></i><span class="d-md-block d-none">{{ trans('messages.add-company') }} </span></a>
					...
					<div class="row align-items-center">
						<div class="col-xl-5 col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control twt-enter-search custom-input" name="search_by_company" placeholder="{{ trans("messages.search-by") }} {{ trans("messages.company-name") }} , {{ trans("messages.company-code") }} , {{ trans("messages.company-short-code") }}">
							</div>
						</div>
						<div class=" col-xl-3">
							<div class="form-group">
						...
						<table class="table table-sm table-bordered table-hover" id="country-table">
							<thead>
								<tr>
									...
									<th class="text-left" width="55%">{{ trans("messages.company-name") }}</th>
									<th class="text-left" width="55%">{{ trans("messages.company-code") }}</th>
									<th class="text-left" width="55%">{{ trans("messages.company-short-code") }}</th>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" name="company_name" class="form-control" placeholder="{{ trans('messages.company-name') }}"> 
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<label for="company_code" class="control-label">{{ trans('messages.company-code') }}<span class="text-danger">*</span></label>
								<input type="text" name="company_code" class="form-control" placeholder="{{ trans('messages.company-code') }}">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<label for="company_short_code" class="control-label">{{ trans('messages.company-short-code') }}<span class="text-danger">*</span></label>
								<input type="text" name="company_short_code" class="form-control" placeholder="{{ trans('messages.company-short-code') }}">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
