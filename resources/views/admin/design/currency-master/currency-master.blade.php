...
<main class="page-height bg-light-color">
	<div class="breadcrumb-wrapper d-flex border-navabr align-items-center">
		...
		<div class="ml-auto pt-sm-0 d-flex align-items-center">
			<button type="button" class="btn btn btn-theme text-white button-actions-top-bar  d-flex align-items-center border btn-sm mr-2" data-toggle="modal" data-target="#add-currency-modal"><i class=" fas fa-plus mr-md-2"></i><span class="d-md-block d-none">{{ trans('messages.add-currency') }} </span></a>
					...
					<div class="row align-items-center">
						<div class="col-xl-4 col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control twt-enter-search custom-input" name="search_by_currency" placeholder="{{ trans("messages.search-by") }} {{ trans("messages.currency-name") }} , {{ trans("messages.currency-code") }}">
							</div>
						</div>
						<!-- <div class="col-xl-3 col-lg-6">
							<div class="form-group">
								<label class="control-label" for="search_currency_name">{{ trans("messages.currency-name") }}</label>
						...
						<table class="table table-sm table-bordered table-hover" id="currency-table">
							<thead>
								<tr>
									...
									<th class="text-left" width="55%">{{ trans("messages.currency-code") }}</th>
							...
							<tbody>
								<tr>
									...
									<td class="text-left" width="55%">USD</td>
									<td class="text-left" width="30%">US-D</td>
								...
								<tr>
									...
									<td class="text-left" width="55%">EURO</td>
									<td class="text-left" width="30%">EURO</td>
									<td class="actions-col" width="20%">
										<div class="custom-control custom-switch">
				...
				<div class="modal-body add-lookup-modal-html">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label for="currency_name" class="control-label">{{ trans('messages.currency-name') }}<span class="text-danger">*</span></label>
								<input type="text" name="currency_name" class="form-control" placeholder="{{ trans('messages.currency-name') }}"> 
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<label for="currency_code" class="control-label">{{ trans('messages.currency-code') }}<span class="text-danger">*</span></label>
								<input type="text" name="currency_code" class="form-control" placeholder="{{ trans('messages.currency-code') }}">
							</div>
						</div>
					</div>
				</div>
...
<script>
	$("form").validate({
		...
		messages: {
			...
			currency_code: {
				required: "{{ trans('messages.require-currency-code') }}"
			},
