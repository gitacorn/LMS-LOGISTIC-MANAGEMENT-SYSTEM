...
<main class="page-height bg-light-color">
	<div class="breadcrumb-wrapper d-flex align-items-center border-navabr">
		...
		<div class="ml-auto pt-sm-0 d-flex align-items-center">
			<a href="{{ url('design-add-us-warehouse-to-amazon-customer-uk-warehouse') }}" class="btn btn btn-theme text-white button-actions-top-bar  border btn-sm mr-2 d-flex align-items-center" title="{{ trans('messages.add') }}"><i class=" fas fa-plus mr-md-1"></i> <span class="d-md-block d-none">{{ trans('messages.add') }}</span></a>
					...
					<div class="row align-items-center">
						<div class="col-xl-6 col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control twt-enter-search custom-input" name="search_by_agent_warehouse" id="search_by_logistic_partner_name" placeholder="{{ trans('messages.search-by') }} {{ trans('messages.entry-no') }}, {{ trans('messages.tracking-no') }}, {{ trans('messages.tracking-link') }}">
							</div>
						</div>
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
							<div class="form-group">
								<label class="control-label" for="search_booking_form_date">{{ trans("messages.booking-from-date") }}</label>
								<input type="text" name="search_booking_form_date" class="form-control date-format" placeholder="{{ trans('messages.booking-from-date') }}">
							</div>
						</div>
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
							<div class="form-group">
						...
						<table class="table table-sm table-bordered table-hover" id="user-table">
							<thead>
								<tr>
									...
									<th class="text-left">{{ trans("messages.booking-date") }} <br> {{ trans("messages.collection-date") }}</th>
							...
							<tbody>
								<tr>
									...
									<td class="text-left">Road<br>(US Warehouse - Customer )
									</td>
									<td class="text-left">Smit Patel</td>
									<td class="text-left">Day Light</td>
									<td class="text-left">09/11/2021 <br> 09/12/2021</td>
									<td class="text-left">123456 <br> <a href="#"> https://www.google.com</a></td>
									<td class="text-left">11/10/2022</td>
								...
								<tr>
									<td>2</td>
									<td class="text-left">AWA-001-22092022 </td>
									<td class="text-left">Road<br>(US Warehouse - Amazon)</td>
									<td class="text-left">Smit Patel</td>
									<td class="text-left">Day Light</td>
									<td class="text-left">09/06/2022 <br> 09/08/2022</td>
									<td class="text-left">123456 <br> <a href="#"> https://www.google.com</a></td>
									<td class="text-left">09/05/2022</td>
									<td class="text-left">Delivered</td>
									<td>
										<a title="Edit Record" href="javascript:void(0);" class="btn btn-sm btn-info mb-1"><i class="fas fa-fw fa-pencil-alt"></i></a>
										<button title="Delete" class="btn btn-sm btn-danger mb-1"><i class="fa fa-trash fa-fw"></i></button>
