...
<div class="pagination-items">
    ...
    */ ?>
    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        ...
        <ul class="pagination">
            <span class="relative z-0 inline-flex shadow-sm rounded-md pagination-text">
                {{-- Previous Page Link --}}
                @if ($paginator->onFirstPage())
                ...
                <span aria-current="page">
                    <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 page-active-link">{{ $page }}</span>
                </span>
                @else
                ...
                <li class="page-item"><a href="javascript:void(0)" onclick="createPagination({{ ( $twtCurrentPage + 1 )  }})" data-page="{{ ( $twtCurrentPage + 1 )}}" rel="next" class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-r-md leading-5 hover:text-gray-400 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150 page-link" aria-label="{{ __('pagination.next') }}">
                        <svg class="w-5 h-5 previous-class next" fill="currentColor" viewBox="0 0 20 20">
